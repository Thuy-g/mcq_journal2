#!/usr/bin/env python3
############################################################################
# scripts/run_category_selector_v3.py
#
# Deterministic, auditable batch runner for the frozen category selector
# (src/category_extractor_ClaudeWeb_v3.py, tag category-selector-v3.3-offline).
#
...
from category_extractor_ClaudeWeb_v3 import (  # noqa: E402
    DEFAULT_CACHE_PATH,
    DEFAULT_ENDPOINT,
    DEFAULT_LANGUAGE,
    DEFAULT_SBERT_MODEL,
...
RUNNER_SCHEMA_VERSION = "category_runner_v1.0"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="run_category_selector_v3.py",
        description=(
            "Batch-run the frozen category selector v3.3 over a list of Answer "
